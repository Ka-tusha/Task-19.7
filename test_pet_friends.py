...
def test_add_new_pet_with_valid_data(name ='leo', animal_type ='Леопард',
                                     age ='1', pet_photo='images/lisa.jpg'):
...
def test_add_new_create_pet_simple_with_valid_data(name ='Пушистик', animal_type ='Зайка',
                                     age ='3'):
...
def test_add_new_pets_set_photo_pet_id_with_valid_data(pet_photo = 'images/rabbit.jpg'):
    ...
    if len(my_pets['pets']) > 0:
        status, result = pf.add_new_pets_set_photo_pet_id(auth_key, my_pets['pets'][0]['id'], pet_photo)
...
def test_add_new_pet(name='//////', animal_type='******', age='hi', pet_photo='images/rabbit.jpg'):
...
def test_successful_update_self_pet_info(name='Заинька', animal_type='Побегаинька', age=2):
